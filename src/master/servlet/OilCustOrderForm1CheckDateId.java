...
/**
 * Servlet implementation class OilCustOrderForm1CheckDateId
 */
public class OilCustOrderForm1CheckDateId extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(flag==1)
		{
			...
			RequestDispatcher rd=request.getRequestDispatcher("OilCustOrderForm1.jsp");
			rd.forward(request, response);
		}
	}

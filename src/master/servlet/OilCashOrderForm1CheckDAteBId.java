...
/**
 * Servlet implementation class OilCashOrderForm1CheckDAteBId
 */
public class OilCashOrderForm1CheckDAteBId extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(flag==0) {
			...
			RequestDispatcher rd=request.getRequestDispatcher("OilCashOrderForm1.jsp");
			rd.forward(request, response);
		}
	}
